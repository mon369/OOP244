...
{
	A.m_health -= B.getAttack();
	if (A.m_health <= 0) { A.m_health = 0; }

	B.m_health -= A.getAttack();
	if (B.m_health <= 0) { B.m_health = 0; }
}
...
{
	A.m_health -= B.getAttack() - A.m_superPowerDefend;
	if (A.m_health <= 0) { A.m_health = 0; }

	B.m_health -= A.getAttack() - B.m_superPowerDefend;
	if (B.m_health <= 0) { B.m_health = 0; }
