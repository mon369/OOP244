...
namespace sict{
    ...
    String::String(const char* pSource){
		strncpy_s(m_pString, pSource, capacity());
    ...
    {
		cout << sizeof(m_pString) << endl;
		if (*this != *other) {
				strncpy_s(m_pString, other.m_pString, capacity());
    ...
    {
		bool i = false;
		if (strcmp(m_pString, s2.m_pString) == 0) { i = true; }
		return i;
    }
    ...
    {
		strcat_s(m_pString, s2.m_pString);
		return *this;
    }
